...
class Im
{
    ...
    public function save(string $file = null, ?int $quality = null, ?int $format = null)
    {
    ...
    public function send($type = ImageType::JPEG, ?int $quality = null)
    {
        $this->im->send($type, $quality);
    }
