...
return [
    ...
    'submodule' => [
        ...
        'facade' => "/Facade{FILENAME}.php",
        'command' => "/Console/{FILENAME}.php",
        'view' => "/views/tw/{filename}.twig",
    ],
    'auth' => [
        'controller' => "/Controller/{FILENAME}.php",
        'model' => "/Model{FILENAME}.php",
        'entity' => "/{FILENAME}",
        'middleware' => "/Middleware/{FILENAME}Middleware.php",
        'validation' => "/Middleware/{FILENAME}Validation.php",
        'job' => "/Jobs/{FILENAME}Job.php",
        'listener' => "/Listener/{FILENAME}Listener.php",
        'facade' => "/Facade{FILENAME}.php",
        'command' => "/Console/{FILENAME}.php",
        'view' => "/views/tw/{filename}.twig",
    ]
